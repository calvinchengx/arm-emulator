...
**[Security → Report a vulnerability](https://github.com/calvinchengx/arm-emulator/security/advisories/new)**.
...
**arm-emulator is a local development tool.** It stores secrets, keys,
