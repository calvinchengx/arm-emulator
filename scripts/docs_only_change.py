...
`check_witnesses.py` fails when a link points at a page that does
    ...
    for row in rows:
        ...
        if status[:1] in ("D", "R"):
            ...
            return False, (
                ...
                "another page's link, which check_witnesses.py asserts")
...
def self_test() -> int:
    ...
    cases: list[tuple[str, bool, str]] = [
        ...
        ("M\twebsite/scripts/sync-docs.mjs", True, "the site generator only renders docs/"),
        ...
        ("D\tdocs/55-new.md", False, "deletion can break a link check_witnesses.py asserts"),
