...
# Nothing is exempt any more: `index` used to be, because sync-docs generated
# a docs index that was deliberately absent from the sidebar. That page is
# gone -- the landing page (website/src/pages/index.astro) is the docs root
# now -- so an exemption here would only hide a page that had fallen out of
